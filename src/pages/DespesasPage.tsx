...
const DespesasPage = () => {
  ...
  if (isLoading) {
    return (
      <div className="p-8 flex items-center justify-center bg-gradient-to-br from-gray-50 via-red-50 to-red-100">
  ...
  return (
    <div className="p-8 bg-gradient-to-br from-gray-50 via-red-50 to-red-100">
