        ...
        <div className="max-w-7xl mx-auto">
          <div className="mb-8">
            <div className="flex items-center gap-3 mb-2">
              ...
              <h1 className="text-3xl font-bold text-gray-900">Companhia do Churrasco</h1>
            </div>
            <p className="text-gray-600">Gestão financeira da Companhia do Churrasco</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
            ...
            <Card>
              ...
              <CardContent>
                <div className="text-2xl font-bold">{companhiaDespesas.length}</div>
              ...
              <CardContent>
                <div className="space-y-4">
                  ...
                  <div className="flex justify-between items-center">
                    ...
                    <span className="text-sm text-blue-600">{despesasFixas} registros</span>
                  </div>
                  <div className="flex justify-between items-center">
