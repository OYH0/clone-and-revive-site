        ...
        <table className="w-full table-fixed min-w-[800px]">
          <thead>
            <tr className="border-b border-gray-200">
              <th className="text-left text-gray-700 py-3 px-2 md:px-4 font-medium text-xs md:text-sm w-20 md:w-24">Data Pagto</th>
              ...
              <th className="text-left text-gray-700 py-3 px-2 md:px-4 font-medium text-xs md:text-sm w-20 md:w-24">Categoria</th>
              <th className="text-left text-gray-700 py-3 px-2 md:px-4 font-medium text-xs md:text-sm w-20 md:w-24">Valor</th>
              <th className="text-left text-gray-700 py-3 px-2 md:px-4 font-medium text-xs md:text-sm w-16 md:w-24">Juros</th>
              <th className="text-left text-gray-700 py-3 px-2 md:px-4 font-medium text-xs md:text-sm w-20 md:w-24">Total</th>
              <th className="text-left text-gray-700 py-3 px-2 md:px-4 font-medium text-xs md:text-sm w-16 md:w-20">Status</th>
              <th className="text-left text-gray-700 py-3 px-2 md:px-4 font-medium text-xs md:text-sm w-28 md:w-36">Ações</th>
            </tr>
          </thead>
          <tbody>
