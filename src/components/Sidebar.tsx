  ...
  if (isMobile) {
    return (
      <>
        ...
        {/* Mobile sidebar */}
        <div className={`fixed left-0 top-0 w-80 bg-gradient-to-b from-blue-600 via-blue-700 to-blue-800 text-white h-screen flex flex-col z-50 shadow-xl transform transition-transform duration-300 md:hidden ${
            ...
            {menuItems.map((item) => {
              ...
              return (
                <button
                  ...
                  className={`w-full flex items-center gap-3 p-4 rounded-xl mb-2 text-left transition-all duration-200 ${
                    isActive 
