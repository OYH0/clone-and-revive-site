...
const Sidebar: React.FC = () => {
      ...
      <>
        ...
        {isOpen && (
          <div className="fixed inset-0 z-50 lg:hidden">
            ...
            {/* Sidebar */}
            <div className="fixed left-0 top-0 h-full w-80 bg-gradient-to-b from-blue-600 via-blue-700 to-blue-800 text-white shadow-xl transform transition-transform">
  ...
  // Desktop Sidebar
  return (
    <div className="fixed left-0 top-0 w-64 bg-gradient-to-b from-blue-600 via-blue-700 to-blue-800 text-white h-screen flex flex-col z-40 shadow-xl hidden lg:flex">
